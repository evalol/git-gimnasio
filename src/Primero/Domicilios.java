...
public class Domicilios implements java.io.Serializable {
	...
	public Domicilios(int idDomicilio, String tipoViaDomicilio,
			String direccionDomicilio, String pisoDomicilio,
			String numeroDomicilio, Integer codigoPostalDomicilio,
			Integer localidadDomicilio, Integer provinciaDomicilio) {
		this.idDomicilio = idDomicilio;
